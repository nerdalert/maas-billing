...
func NewPolicyManager(kuadrantClient dynamic.Interface, clientset *kubernetes.Clientset, keyNamespace, tokenRateLimitPolicyName string) *PolicyManager {
...
// verifyPolicyReload checks if TokenRateLimitPolicy is in Enforced state
func (p *PolicyManager) verifyPolicyReload() error {
	...
	return fmt.Errorf("timeout waiting for TokenRateLimitPolicy to be enforced")
}
